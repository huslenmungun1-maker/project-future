...
import { CoreAssistantPanel } from "../(studio)/CoreAssistantPanel";
...
const UI_TEXT = {
  en: {
    ...
    readerBody: "Eventually this will display views, likes, and recent readers.",
...
export default function Home() {
  ...
  const locale: SupportedLocale =
    (["en", "mn", "ko", "ja"].includes(rawLocale) ? rawLocale : "en") as SupportedLocale;
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-950/70 p-5">
            ...
            <form className="flex flex-col gap-3" onSubmit={handleCreate}>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs text-slate-300">{t.fieldTitle}</label>
                <input
                ...
                {currentSubgenreOptions.length === 0 ? (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {currentSubgenreOptions.map((sg) => (
                      <label
                        key={sg.id}
                        className="inline-flex items-center gap-1 rounded-full border border-slate-700 bg-black/40 px-2 py-1 text-[11px] text-slate-200 cursor-pointer"
                      >
                        <input
                          type="checkbox"
                  ...
                  >
                    <div className="flex items-stretch justify-between">
                      ...
                      <button
                        ...
                        className="m-3 h-fit rounded-lg border border-red-500 px-3 py-1 text-[11px] text-red-400 hover:bg-red-500 hover:text-white transition"
                      >
                        Delete
                      </button>
                    </div>
